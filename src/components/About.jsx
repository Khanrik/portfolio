...
export const About = () => {
    return (
        <section id="about">
            <RevealOnScroll>
                <div className="w-screen min-h-screen flex flex-col text-white items-center justify-center">
                    <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center justify-between">
                        <div className="max-w-xl">
                            <h1 className="text-4xl font-bold text-purple-400 mb-4">About</h1>
                            <p className="text-xl">
                        ...
                        <div className="mb-8 md:mb-0 md:ml-8">
                            <div className="w-64 h-64 bg-black rounded-full flex items-center justify-center">
                                <img
                                    src={ReactLogo}
                                    alt="Profile"
                                    className="w-48 h-48 object-contain text-blue-400"
                                />
                            </div>
                        </div>
                    </div>
