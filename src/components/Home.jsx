...
export const Home = () => {
    return (
        <div className="w-screen h-screen bg-gradient-to-b from-[#1A1824] to-[#121212] flex flex-col items-center justify-center text-white overflow-hidden fixed inset-0">
            {/* Main Content */}
