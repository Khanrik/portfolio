            ...
            <RevealOnScroll>
                <div className="text-center my-8 w-9/10 mx-auto">
                    ...
                    <div className="relative w-9/10 mx-auto">
                        ...
                        <button
                            onClick={scrollLeft}
                            className="absolute left-[-40px] top-1/2 transform -translate-y-1/2 bg-[var(--cardBackground)] text-[var(--bodyText)] p-2 rounded-full shadow-md hover:bg-[var(--headerText)] transition z-10
                            cursor-pointer"
                        >
                            <FaArrowLeft />
                        </button>
